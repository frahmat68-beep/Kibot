...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("int", "KIBOT_GEMINI_SUPPORT_MAX_CANDIDATES", envOrDefault("GEMINI_SUPPORT_MAX_CANDIDATES", "8"))
        buildConfigField("int", "KIBOT_GEMINI_SUPPORT_MIN_INTERVAL_MINUTES", envOrDefault("GEMINI_SUPPORT_MIN_INTERVAL_MINUTES", "180"))
        ...
        buildConfigField("int", "KIBOT_GEMINI_SUPPORT_HOURLY_REQUEST_BUDGET", envOrDefault("GEMINI_SUPPORT_HOURLY_REQUEST_BUDGET", "3"))
