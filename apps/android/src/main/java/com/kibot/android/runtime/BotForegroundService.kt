...
class BotForegroundService : Service() {
    ...
    override fun onCreate() {
        super.onCreate()
        ensureChannel()
        startForeground(NOTIFICATION_ID, buildNotification(currentPair = null))
    }
    ...
    private fun buildNotification(currentPair: String?): Notification {
    ...
    private suspend fun runLoop() {
        ...
        while (serviceScope.isActive) {
            try {
                ...
                updateNotification(currentPair = pairLabel)
    ...
    private fun updateNotification(currentPair: String?) {
        val manager = getSystemService(NotificationManager::class.java)
        manager.notify(NOTIFICATION_ID, buildNotification(currentPair))
    }
