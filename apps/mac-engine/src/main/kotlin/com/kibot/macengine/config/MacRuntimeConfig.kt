...
object MacRuntimeConfigLoader {
    fun load(cwd: Path = Paths.get("").toAbsolutePath()): MacRuntimeConfig {
        ...
        return MacRuntimeConfig(
            ...
            balanceRefreshIntervalMillis = optional("BOT_BALANCE_REFRESH_INTERVAL_MS")?.toLongOrNull() ?: 8_000L,
            openOrdersRefreshIntervalMillis = optional("BOT_OPEN_ORDERS_REFRESH_INTERVAL_MS")?.toLongOrNull() ?: 8_000L,
            ...
            commandsRefreshIntervalMillis = optional("BOT_COMMANDS_REFRESH_INTERVAL_MS")?.toLongOrNull() ?: 10_000L,
            weeklySummaryRefreshIntervalMillis = optional("BOT_WEEKLY_SUMMARY_REFRESH_INTERVAL_MS")?.toLongOrNull() ?: 60_000L,
            recentOrdersRefreshIntervalMillis = optional("BOT_RECENT_ORDERS_REFRESH_INTERVAL_MS")?.toLongOrNull() ?: 15_000L,
            recentFillsRefreshIntervalMillis = optional("BOT_RECENT_FILLS_REFRESH_INTERVAL_MS")?.toLongOrNull() ?: 15_000L,
