...
logger = logging.getLogger("kicryp_v2")
...
STATE_DIR    = Path(os.environ.get("KICRYP_STATE_DIR", "/Users/kiki/Documents/Web Develop/KiBot/state"))
...
MAX_POSITIONS_A    = 3
MAX_POSITIONS_B    = 2
SCREEN_INTERVAL_S  = 30        # Scan Bucket B setiap 30 detik
