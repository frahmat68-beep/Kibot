...
FAST_MAX_INPUT_CHARS = int(os.getenv("KIBOT_OLLAMA_GATEWAY_FAST_MAX_INPUT_CHARS", "5000"))
DEFAULT_MAX_INPUT_CHARS = int(os.getenv("KIBOT_OLLAMA_GATEWAY_DEFAULT_MAX_INPUT_CHARS", "8000"))
