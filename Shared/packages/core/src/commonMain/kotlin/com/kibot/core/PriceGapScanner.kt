...
/**
 * PriceGapScanner - Detect arbitrage antara Binance (Kinance) dan Indodax (KiBot)
 * 
 * Purpose:
 * - Kinance scan Binance, kirim harga ke KiBot
 * - KiBot scan Indodax, kirim harga ke KiBot
        ...
        return when (opportunity.interpretation) {
            ArbitrageInterpretation.BULLISH_INDODAX -> {
                ...
                PriceGapSignal(
                    ...
                    actionForKiBot = "HIGH PRIORITY for entry, but be careful of dump",
                )
            }
            ArbitrageInterpretation.BEARISH_INDODAX -> {
                ...
                PriceGapSignal(
                    ...
                    actionForKiBot = "Be very careful, selling pressure strong here",
                )
            }
            ArbitrageInterpretation.NEUTRAL -> {
                PriceGapSignal(
                    ...
                    actionForKiBot = "Use standard strategy",
                )
            }
        }
    }
