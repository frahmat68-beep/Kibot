...
/**
 * SharedPositionTracker - ALL 3 bots know what KiBot is holding
 * 
 * When KiBot buys:
 * - Broadcast UDP: "I bought BTC at 150, fee 0.3%, target 165"
 * - KiBot knows: "OK, BTC position open, watch Binance for exit signal"
...
class SharedPositionTracker {
    ...
    /**
     * Broadcast when KiBot opens position
     */
    ...
    /**
     * Broadcast when KiBot closes position
     */
