 ...
 * KiBot:   "I'm alive!" (every 10s)
 * 
 * If KiBot stops talking:
 * KiBot:   "Eh KiBot mati! Gw restart dia!"
 * KiBot:   "Gw juga coba restart KiBot!"
 */
class TrinityHeartbeatMonitor {
     ...
     */
    fun recordHeartbeat(
        botName: String,  // "KiBot", "KiBot", or "kibot"
    ...
    fun checkDeadBots(now: Instant = Clock.System.now()): List<DeadBotAlert> {
        ...
        val requiredBots = listOf("KiBot", "KiBot", "kibot")
