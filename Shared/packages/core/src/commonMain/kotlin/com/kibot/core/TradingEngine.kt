...
interface TradingEngine {
    ...
    fun evaluateSignal(udpSignal: KiBotSignal): EngineSignalDecision?

    fun executeEntry(pair: String, signal: KiBotSignal): EngineSignalDecision? {
