...
enum class MessageType {
    ...
    POSITION_UPDATE,       // KiBot → KiBot: "Bought BTC"
    BUY_REQUEST,           // KiBot → KiBot: "Want to buy ABC"
    BUY_APPROVAL,          // KiBot → KiBot: "Approved!"
    BUY_REJECTION,         // KiBot → KiBot: "VETO!"
    SELL_REQUEST,          // KiBot → KiBot: "Want to sell ABC"
    SELL_APPROVAL,         // KiBot → KiBot: "Approved!"
    SELL_REJECTION,        // KiBot → KiBot: "HOLD!"
    HEARTBEAT,             // Any bot: "I'm alive"
    ALERT,                 // Any bot: "Emergency!"
    PRICE_UPDATE,          // Kinance/KiBot: Price info
}
