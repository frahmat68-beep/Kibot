...
def test_math_engine():
    ...
    try:
        ...
        # Lower threshold to 0.50 (Bayesian minimum) to prevent missing high-conviction pumps
...
def test_ai_fallback_chain():
    ...
    coordinator_path = ROOT / "core" / "kibot_ai_coordinator.py"
...
def test_analyst_entrypoint():
    ...
    analyst_path = ROOT / "core" / "kibot_analyst.py"
