...
class CapitalDeploymentEngineTest {
    ...
    fun `keeps second slot closed when follow-up candidate is weak`() {
        ...
        assertEquals(4, plan.maxActivePositions)
    ...
    fun `stagnant full portfolio can still open rotation path for stronger candidate`() {
        ...
        val portfolio = PortfolioSnapshot(
            ...
            positions = listOf(
                PositionSnapshot(
                    positionId = com.kicryp.shared.models.PositionId("ont-1"),
                ...
                PositionSnapshot(
                    positionId = com.kicryp.shared.models.PositionId("xrp-1"),
    ...
    fun `free cash above twenty thousand keeps parallel slot open during active hold`() {
        ...
        val portfolio = PortfolioSnapshot(
            ...
            positions = listOf(
                PositionSnapshot(
                    positionId = com.kicryp.shared.models.PositionId("drx-1"),
