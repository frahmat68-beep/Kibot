...
import com.kicryp.shared.models.AiSupportCandidate
...
data class StrategyCycleResult(
    ...
    val deploymentPlan: com.kicryp.shared.models.CapitalDeploymentPlan,
...
class StrategyOrchestrator(
    ...
    private fun deriveSetupReadiness(
        ...
        val setupType: com.kicryp.shared.models.SetupType
    ...
    private fun scoreEntryCandidate(
        ...
        val regimeBias = when {
            setupReadiness.setupType == com.kicryp.shared.models.SetupType.SWING_TREND_CONTINUATION ->
        ...
        val followThroughScore = when (setupReadiness.setupType) {
            com.kicryp.shared.models.SetupType.SWING_TREND_CONTINUATION ->
                averageOf(pairScore.holdabilityScore, pairScore.trendQualityScore)
            com.kicryp.shared.models.SetupType.HEALTHY_SHORT_TERM_PULLBACK ->
    ...
    private fun StrategySignal.toExecutionPlan(
        ...
        val strongBreakoutMomentum = setupType == com.kicryp.shared.models.SetupType.LIGHT_BREAKOUT_CONTINUATION &&
    ...
    private fun applySupportHints(
        ...
        return rankedPairs
            ...
            .sortedWith(
                compareByDescending<PairScore> { it.pairTier == com.kicryp.shared.models.PairTier.TIER_A }
