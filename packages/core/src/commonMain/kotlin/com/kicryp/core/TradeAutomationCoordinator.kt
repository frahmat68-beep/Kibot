...
data class ManagedPosition(
    ...
    val pairTier: com.kicryp.shared.models.PairTier,
...
class TradeAutomationCoordinator(
    ...
    fun deriveManagedPositions(
        ...
        return balances.mapNotNull { balance ->
            ...
            ManagedPosition(
                ...
                pairTier = rankedPair?.pairTier ?: com.kicryp.shared.models.PairTier.TIER_B,
    ...
    private fun buildExitDecision(
        ...
        pairScore: PairScore?,
        replacementCandidates: List<com.kicryp.shared.models.CandidateOpportunity>,
        ...
        val exitReason = when {
            ...
            riskDecision.profitProtectionStatus != com.kicryp.shared.models.ProfitProtectionStatus.INACTIVE &&
    ...
    private fun shouldRotateLoser(
        position: ManagedPosition,
        positionPairScore: PairScore?,
        topCandidate: com.kicryp.shared.models.CandidateOpportunity?,
        ageHours: Double,
        allowRotation: Boolean,
    ): Boolean {
    ...
    private fun com.kicryp.shared.models.CandidateOpportunity.hasNetRotationUpgradeOver(
        position: ManagedPosition,
        positionPairScore: PairScore?,
