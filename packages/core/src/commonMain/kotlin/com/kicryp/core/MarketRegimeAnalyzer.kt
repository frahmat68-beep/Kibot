...
class MarketRegimeAnalyzer(
    ...
    private fun deriveBotHealthScore(health: EngineHealthSnapshot): Double {
        val statusScore = when (health.status) {
            com.kicryp.shared.models.HealthStatus.HEALTHY -> 1.0
            com.kicryp.shared.models.HealthStatus.WARNING -> 0.60
            com.kicryp.shared.models.HealthStatus.CRITICAL -> 0.20
        }
        val syncScore = when (health.syncHealth) {
            com.kicryp.shared.models.SyncHealth.HEALTHY -> 1.0
            com.kicryp.shared.models.SyncHealth.DEGRADED -> 0.60
            com.kicryp.shared.models.SyncHealth.BROKEN -> 0.15
        }
