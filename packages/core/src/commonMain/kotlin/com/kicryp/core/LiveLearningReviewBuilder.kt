...
import com.kicryp.shared.models.ExecutionAnomalySignature
import com.kicryp.shared.models.LearningObservation
...
class LiveLearningReviewBuilder(
    ...
    private fun buildRealizedRoundTripBySellOrder(
        recentOrders: List<OrderSnapshot>,
    ): Map<com.kicryp.shared.models.OrderId, RealizedRoundTrip> {
        data class OpenLot(
            val quantity: Double,
            val price: Double,
        )

        val lotsByPair = mutableMapOf<com.kicryp.shared.models.PairId, ArrayDeque<OpenLot>>()
        val realizedByOrder = mutableMapOf<com.kicryp.shared.models.OrderId, RealizedRoundTrip>()
