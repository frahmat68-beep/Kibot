...
import com.kicryp.shared.models.CapitalDeploymentPlan
import com.kicryp.shared.models.CandidateOpportunity
...
class CapitalDeploymentEngine(
    ...
    fun plan(
        ...
        val dominantTierAReady = openPositions == 0 &&
            ...
            firstCandidate?.tier == com.kicryp.shared.models.PairTier.TIER_A &&
        ...
        val topCandidateLooksLikeBreakout = firstCandidate?.let { candidate ->
            candidate.speculativePocket ||
                (
                    candidate.preferredHorizon == com.kicryp.shared.models.TradingHorizon.TACTICAL &&
