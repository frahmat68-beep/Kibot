...
data class PairSelectionPolicy(
    ...
    val speculativeMinShortTermReturnPct: Double = 0.25,
    val speculativeMaxShortTermReturnPct: Double = 220.0,
    val speculativeMinMediumTermReturnPct: Double = 0.25,
    val speculativeMinTradeActivityScore: Double = 0.48,
    val speculativeMinDepthScore: Double = 0.36,
    val speculativeMinHistoricalExpectancyScore: Double = 0.22,
)
...
data class RiskConfig(
    ...
    val rotationMinNetUpgradePct: Double = 1.25,
    val rotationMinClearProfitPct: Double = 0.90,
    val rotationMinClearProfitIdr: Double = 140.0,
...
data class StrategyExecutionConfig(
    ...
    val marketEntryMinExpectedNetProfitPct: Double = 0.56,
    ...
    val breakoutAggressiveEntryMinRankingScore: Double = 0.56,
    val breakoutAggressiveEntryMinExpectedNetProfitPct: Double = 0.56,
    val breakoutAggressiveEntryMinShortTermReturnPct: Double = 0.70,
    val breakoutAggressiveEntryMinMediumTermReturnPct: Double = 0.40,
