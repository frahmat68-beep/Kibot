...
data class RiskConfig(
    ...
    val maxPerPositionBudgetPct: Double = 0.55,
...
data class StrategyExecutionConfig(
    ...
    val growthMinRankingScore: Double = 0.74,
    val defensiveMinRankingScore: Double = 0.82,
    val attackMinRankingScore: Double = 0.70,
    val minExpectedOpportunityScore: Double = 0.62,
