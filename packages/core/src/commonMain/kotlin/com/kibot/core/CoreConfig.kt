...
data class StrategyExecutionConfig(
    ...
    val entrySpendBufferPct: Double = 0.005,
    val growthMinRankingScore: Double = 0.63,
    val defensiveMinRankingScore: Double = 0.82,
    val attackMinRankingScore: Double = 0.56,
    val minExpectedOpportunityScore: Double = 0.46,
    val candidateCount: Int = 64,
    ...
    val marketEntryMinRankingScore: Double = 0.55,
