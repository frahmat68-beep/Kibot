...
data class StrategyExecutionConfig(
    ...
    val marketEntryMinRankingScore: Double = 0.64,
    val marketEntryMinExpectedNetProfitPct: Double = 0.22,
    val marketEntryMaxSpreadPct: Double = 0.48,
    val marketEntryMaxSlippagePct: Double = 0.44,
    val marketEntryMinTradeActivityScore: Double = 0.58,
