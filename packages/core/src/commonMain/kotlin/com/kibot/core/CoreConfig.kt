...
data class PairSelectionPolicy(
    ...
    val shortlistSize: Int = 18,
    val prefilterCandidatePoolSize: Int = 48,
...
data class RiskConfig(
    ...
    val minimumCashReservePct: Double = 0.10,
...
data class StrategyExecutionConfig(
    ...
    val candidateCount: Int = 14,
    val productiveIdleRankingDelta: Double = 0.03,
    val productiveIdleOpportunityDelta: Double = 0.04,
