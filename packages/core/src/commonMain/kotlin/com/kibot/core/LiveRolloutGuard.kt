...
data class LiveRolloutConfig(
    val shadowMinRankingScore: Double = 0.70,
    val shadowMinExpectedEdgePct: Double = 0.40,
    ...
    val speculativeMinRankingScore: Double = 0.64,
    val speculativeMinExpectedEdgePct: Double = 0.40,
    val speculativeMaxWeeklyFalseEntryRate: Double = 0.50,
    val speculativeAggressiveOverrideMaxWeeklyFalseEntryRate: Double = 0.70,
    val speculativeAggressiveOverrideMinRankingScore: Double = 0.70,
    val speculativeAggressiveOverrideMinExpectedEdgePct: Double = 0.44,
    ...
    val aggressiveOverrideMinExpectedEdgePct: Double = 0.46,
