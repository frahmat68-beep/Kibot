...
class VetoService {
    fun shouldVetoEntry(
        ...
        // Rule 0: AI LEGION VETO (Meta-Opinion)
        // If AI consensus is strongly negative, block even if technicals are green.
        if (aiConsensus != null && aiConsensus < 0.35) {
            return true // AI Veto - Legion detects hidden risk
        }
