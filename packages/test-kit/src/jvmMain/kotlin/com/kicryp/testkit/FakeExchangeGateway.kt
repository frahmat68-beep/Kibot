...
class FakeExchangeGateway(
    ...
    override suspend fun placeOrder(plan: ExecutionPlan, clientOrderId: ClientOrderId): OrderSnapshot {
        ...
        return OrderSnapshot(
            ...
            executedQuantity = com.kicryp.shared.models.DecimalValue.Zero,
    ...
    fun recordFill(order: OrderSnapshot, quantity: String, price: String) {
        fills += FillSnapshot(
            ...
            pairId = order.pairId,
            side = order.side,
            quantity = com.kicryp.shared.models.DecimalValue(quantity),
            price = com.kicryp.shared.models.DecimalValue(price),
            fee = com.kicryp.shared.models.DecimalValue.Zero,
            feeAsset = "idr",
    ...
    fun markLatestOrderFilled(pairId: PairId, side: com.kicryp.shared.models.OrderSide) {
        ...
        orders[index] = current.copy(
            ...
            remainingQuantity = com.kicryp.shared.models.DecimalValue.Zero,
            updatedAt = Clock.System.now(),
        )
    }
}
