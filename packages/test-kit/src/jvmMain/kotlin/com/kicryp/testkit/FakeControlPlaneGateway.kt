...
import com.kicryp.core.DeviceRegistration
import com.kicryp.core.KingDashboardSnapshot
import com.kicryp.core.TradeHistoryRecord
...
import com.kicryp.shared.models.UserId
...
class FakeControlPlaneGateway(
    ...
    var botState: BotStateSnapshot = BotStateSnapshot(
        ...
        syncHealth = com.kicryp.shared.models.SyncHealth.DEGRADED,
        strategyMode = com.kicryp.shared.models.StrategyMode.AUTO_CONSERVATIVE,
    ...
    override suspend fun acquireLease(botId: BotId, deviceId: DeviceId, ttlSeconds: Int): EngineLeaseSnapshot {
        ...
        botState = botState.copy(
            ...
            lastHeartbeatAt = nowProvider(),
            syncHealth = com.kicryp.shared.models.SyncHealth.HEALTHY,
        )
        return acquired
    }
    ...
    override suspend fun markConflictSafeMode(botId: BotId, reason: String) {
        ...
        botState = botState.copy(
            ...
            syncHealth = com.kicryp.shared.models.SyncHealth.BROKEN,
            safeModeReason = reason,
        )
    }
