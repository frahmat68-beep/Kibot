...
HEALTHCHECK_TIMEOUT_SECONDS="${KIBOT_RECOVERY_HTTP_TIMEOUT_SECONDS:-20}"
ALLOW_SLOW_PORT_FALLBACK="${KIBOT_RECOVERY_ALLOW_SLOW_PORT_FALLBACK:-true}"
WARMUP_GRACE_SECONDS="${KIBOT_RECOVERY_WARMUP_GRACE_SECONDS:-300}"
