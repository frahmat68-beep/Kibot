...
STATE_FILE="${KICRYP_RECOVERY_STATE_FILE:-${RUNTIME_ROOT}/.recovery-state}"
...
MAX_ATTEMPTS="${KICRYP_RECOVERY_MAX_ATTEMPTS:-3}"
BASE_DELAY_SECONDS="${KICRYP_RECOVERY_BASE_DELAY_SECONDS:-6}"
MAX_DELAY_SECONDS="${KICRYP_RECOVERY_MAX_DELAY_SECONDS:-30}"
EXPECT_LIVE_EXECUTION="${KICRYP_EXPECT_LIVE_EXECUTION:-true}"
HEALTHCHECK_TIMEOUT_SECONDS="${KICRYP_RECOVERY_HTTP_TIMEOUT_SECONDS:-20}"
ALLOW_SLOW_PORT_FALLBACK="${KICRYP_RECOVERY_ALLOW_SLOW_PORT_FALLBACK:-true}"
WARMUP_GRACE_SECONDS="${KICRYP_RECOVERY_WARMUP_GRACE_SECONDS:-300}"
TELEGRAM_BOT_TOKEN="${KICRYP_TELEGRAM_BOT_TOKEN:-${TELEGRAM_BOT_TOKEN:-}}"
TELEGRAM_CHAT_ID="${KICRYP_TELEGRAM_CHAT_ID:-${TELEGRAM_CHAT_ID:-}}"
